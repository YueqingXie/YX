...
<div className="container">
    ...
    <li><a href="/projectsCN" className="btn btn-floating transparent">CN</a></li>
    ...
    <ul className="sidenav grey lighten-2" id="mobile-menu">
        ...
        <li><a href="/#aboutmenav" className="sidenavtext">About Me</a></li>
            <br/>
            <li><a href="/projectsCN" className="sidenavtext">CN</a></li>
            ...
            <section className="container section">
                <h4 className="titleENG center">YX-Interview-Projects</h4>
                  <div className="YX-Ps">
                    <div className="row">
                  ...
                  <div className="YX-Ps">
                    <div className="row">
                        <div className="col s12 m6 l6">
                            <p>YX-Mensio Mental Health (ToDo List): </p>
