...
class contact extends Component {
    ...
    render() {
          if( this.state.password == "8732881026"){
            return <Redirect to = '/contact8732881026'/>
        }
...
<div className="container">
    ...
    <li><a href="/contactCN" className="btn btn-floating transparent">CN</a></li>
    ...
    <ul className="sidenav grey lighten-2" id="mobile-menu">
        ...
        <li><a href="/#aboutmenav" className="sidenavtext">About Me</a></li>
            <br/>
            <li><a href="/contactCN" className="sidenavtext">CN</a></li>
            ...
            <h4 className="titleENG center">YX-Contact</h4>
                ...
                <div className="row hide-on-small-only">
                    ...
                    <div className="col m4 l4  push-m1 push-l1 ">
                        <div>
                            <i className="material-icons left">email</i><p><strong>Email: </strong>xieyueqingxyq@gmail.com</p>
                        </div>
                        <div>

                        <form onSubmit={this.handleSubmit} className="transparent ">
                            <div className="input-field">
                                <label htmlFor="password" className="numAuthTitle black-text">Enter Password to see phone number:</label>
