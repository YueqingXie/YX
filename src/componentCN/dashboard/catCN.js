...
<div className="container">
    ...
    <li><a href="/cat" className="btn btn-floating transparent">ENG</a></li>
    ...
    <ul className="sidenav grey lighten-2" id="mobile-menu">
        ...
        <li><a href="/CN#aboutmenavCN" className="sidenavtext">关于我</a></li>
            <br/>
            <li><a href="/cat" className="sidenavtext">ENG</a></li>
            ...
            <h4 className="titleENG center">我的猫</h4>
                ...
                <h4 className="titleENG center">一些照片...</h4>    
