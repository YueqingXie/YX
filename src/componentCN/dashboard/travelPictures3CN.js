...
class travelPictures3CN extends Component {
...
<div className="container">
    ...
    <li><a href="/travelPicturesCanada" className="btn btn-floating transparent">ENG</a></li>
    ...
    <ul className="sidenav grey lighten-2" id="mobile-menu">
        ...
        <li><a href="/CN#aboutmenavCN" className="sidenavtext">关于我</a></li>
            <br/>
            <li><a href="/travelPicturesCanada" className="sidenavtext">ENG</a></li>
            ...
            <ul className="tabs">
                    ...
                    <li className="tab">
                    <a href="#picsThailand" className="indigo-text text-darken-4">泰国</a>
                    </li>
                    <li className="tab">
                    <a href="#picsCanada" className="active indigo-text text-darken-4">加拿大</a>
                    </li>
                    <li className="tab">
...
export default travelPictures3CN;