...
class travelPictures4CN extends Component {
...
<div className="container">
    ...
    <li><a href="/travelPicturesUSA" className="btn btn-floating transparent">ENG</a></li>
    ...
    <ul className="sidenav grey lighten-2" id="mobile-menu">
        ...
        <li><a href="/CN#aboutmenavCN" className="sidenavtext">关于我</a></li>
            <br/>
            <li><a href="/travelPicturesUSA" className="sidenavtext">ENG</a></li>
            ...
            <ul className="tabs">
                    ...
                    <li className="tab">
                    <a href="#picsUSA" className="active indigo-text text-darken-4">美国</a>
                    </li>
            </ul>
            </div>
            </div>
...
export default travelPictures4CN;