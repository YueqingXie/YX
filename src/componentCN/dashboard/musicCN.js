...
class musicCN extends Component {
    // state = {
...
<div className="container">
    ...
    <li><a href="/music" className="btn btn-floating transparent">ENG</a></li>
    ...
    <ul className="sidenav grey lighten-2" id="mobile-menu">
        ...
        <li><a href="/CN#aboutmenavCN" className="sidenavtext">关于我</a></li>
            <br/>
            <li><a href="/music" className="sidenavtext">ENG</a></li>
            ...
            <div className="row">
                ...
                <ul className="tabs">
                    ...
                    <a href="#guitar" className="active black-text">吉他</a>
                    </li>
                    <li className="tab col s3">
                    <a href="#piano" className="black-text">钢琴</a>
                    </li>
                    <li className="tab col s3">
                    <a href="#guzheng" className="black-text">古筝</a>
                    </li>
                    <li className="tab col s3">
                    <a href="#flute" className="black-text">竹笛</a>
                    </li>
                </ul>
                </div>
            </div>
            ...
            <div className="row">
                <div className="col s12 m6 l3">
                    {/* <div className="video" id="video56">
                        <video controls src="../video_music/56.mp4" width="200" height="280"></video>
                    </div> */}
                </div>

                <div className="col s12 m6 l3">
                    {/* <div className="video" id="video55">
                        <video controls src="../video_music/55.mp4" width="200" height="280"></video>
                    </div> */}
                </div>
